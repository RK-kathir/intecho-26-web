...
// 1. Added "Office Bearers" to the list right before Sponsors
const navLinks = [
  "Home", "About", "Passes", "Events", "Workshops", "Office Bearers", "Sponsors", "About MIT", "Contact"
];
...
// 2. Mapped "Office Bearers" to the #office-bearers section ID
        ...
        <nav className="hidden lg:flex items-center gap-6">
          {navLinks.map((link) => (
            <button
              ...
              className="font-body text-xs uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors whitespace-nowrap"
            >
              {link}
            </button>
          ))}
